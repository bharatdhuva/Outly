...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-30 w-full h-full flex flex-col justify-between">{children}</div>
    </div>
  );
...
const GlassDock: React.FC<{ icons: DockIcon[]; href?: string }> = ({
  ...
  <GlassEffect
    href={href}
    className="rounded-3xl p-3 hover:p-4 hover:rounded-4xl font-semibold text-black cursor-pointer"
  >
...
const GlassButton: React.FC<{ children: React.ReactNode; href?: string }> = ({
  ...
  <GlassEffect
    href={href}
    className="rounded-3xl px-10 py-6 hover:px-11 hover:py-7 hover:rounded-4xl overflow-hidden font-semibold text-black cursor-pointer"
  >
    <div
...
export const Component = () => {
  ...
  return (
    <div
      className="min-h-[400px] h-full flex items-center justify-center font-light relative overflow-hidden w-full rounded-3xl"
      style={{
        background: `url("https://images.unsplash.com/photo-1432251407527-504a6b4174a2?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D") center center`,
        backgroundSize: "cover",
      }}
