...
export async function generateDailyTweet(
  ...
  if (voiceEnabled && voiceProfile) {
    voicePrompt = `
Additionally, you MUST write the tweet in the following voice and style. Here are examples of how the user writes:
---
${voiceProfile}
---
Match the style, pattern, sentence length, and vocabulary of these examples precisely. Do not sound like a generic AI assistant.`;
  }
...
export async function generateWeeklyThread(
  ...
  if (voiceEnabled && voiceProfile) {
    voicePrompt = `
Additionally, you MUST write this thread in the following voice and style. Here are examples of how the user writes:
---
${voiceProfile}
---
Match the style, pattern, sentence length, and vocabulary of these examples precisely. Do not sound like a generic AI assistant.`;
